// BC Documentation: https://learn.microsoft.com/en-us/dynamics365/business-central/dev-itpro/developer/methods-auto/globals/usersecurityid-method
// Scope: in-scope
// Fixtures used: USI Buffer (60858), USI Reader (60859)
//
// Migrated from AL Runner tests/runner-extras/user-security-id (UsiTests.Codeunit.al).
//
/// <summary>
