// BC Documentation: https://learn.microsoft.com/en-us/dynamics365/business-central/dev-itpro/developer/methods-auto/textencoding/textencoding-data-type
// Scope: in-scope
// Fixtures used: TEW Blob (60856)
//
// Migrated from AL Runner tests/runner-extras/text-encoding-windows (TewTests.Codeunit.al).
//
/// <summary>
