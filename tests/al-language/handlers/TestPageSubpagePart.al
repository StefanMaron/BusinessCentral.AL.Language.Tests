...
// Scope: in-scope
// Fixtures used: TSP Header (60849), TSP Line (60850), TSP Card (60851), TSP Lines (60852), TSP Lines RO (60853), TSP Card RO Lines (60854); shared Assert (60021)
//
// Migrated from AL Runner tests/runner-extras/testpage-subpage-part (TspTests.Codeunit.al).
// The suite's own "TSP Assert" helper (source codeunit 61964) mapped 1:1 onto the shared
// Assert codeunit — same AreEqual(Text,Text,Text) / IsTrue / IsFalse / ExpectedError(Text)
...
/// for every part-hosted New(). Eight tests failed exactly this way.
///
